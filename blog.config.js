...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID ||'f1bd875f17a143b58b41184ce21808f5',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS ||['山高有行路，水深有渡舟', '岁岁长欢愉，万事皆胜意','岁岁年年，万喜万般宜🎉'],

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '彩潭有鲤', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '彩潭有鲤,便是晴天', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK ||  'https://xukai.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xk12010313@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '苏ICP备2022013116号', // 备案号 闽ICP备XXXXXXX
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID ||'7NdKR-oMacEKJcNf1QS7l',
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'd00f0847c7cf082be381c70541862d15', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID ||  'G-7S1PP0W4YX', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || '8361696780873530', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
